...
namespace SZS
{
    ...
    public static class SARC
    {
        ...
        public static Tuple<int, byte[]> PackN(SarcData data, int _align = -1)
        {
            ...
            BinaryDataWriter bs = new BinaryDataWriter(o, leaveOpen: false);
            bs.ByteOrder = data.endianness;
        ...
        public static SarcData UnpackRamN(Stream src)
        {
            ...
            return new SarcData() { endianness = bs.ByteOrder, HashOnly = HashOnly, Files = res };
        }
